...
Outside. A leper lived apart, with torn clothes and uncovered head, calling *unclean, unclean* at
anyone who came near.

Nothing in the law cures leprosy. Leviticus 13 and 14 do not contain a treatment — they contain a
procedure for what to do **when it has already gone**, and the priest's job is to inspect and
confirm, not to heal.
...
Word for word. The same three points, the same side, the same order.

The ceremony for restoring an outcast is the ceremony for consecrating a high priest.

## What that says

He is not readmitted on probation, or let back in at the edge of things. He is brought in by the
rite used to install a man into the holiest office Israel had.
...
The oil never goes on a spot the blood has not covered first — the same order as the priests'
consecration. See the note on Leviticus 8:30.
...
The law had a full ceremony for a cleansed leper and no way to produce one. For fourteen hundred
years the priesthood held a procedure it had almost never had occasion to run — and then men
started arriving at the temple asking for it.
...
> **The same three points.** Right ear, right thumb, right toe — for the high priest at his
> ordination, and for a man being let back into the camp. Leviticus uses one ceremony for both.
