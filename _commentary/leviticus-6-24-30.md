...
The Hebrew is **torat ha-chattat** — the law, or instruction, of the sin offering.
...
The sin offering is not handled apart from the rest, or in some lesser corner.
...
The offering for sin is given the highest classification in the system.
...
Everywhere else in the Levitical system, contact runs the other direction. Touch a corpse
and you are unclean; touch a leper and you are unclean; the uncleanness travels.
...
arrangement, and the bull for the priest's own sin.
...
## Where the contagion goes in the Gospels

A leper is touched and is cleansed. A bier is touched and the boy sits up. A woman with a
twelve-year haemorrhage takes hold of the hem and *the fountain of her blood was dried up*.
See the note on Mark 5:30–34.

Every one of those contacts should have transmitted uncleanness under the law, and every
one runs the other way.

> **The line that reverses the system.** *Whatever touches its flesh becomes holy.*
> Everywhere else in Leviticus contamination travels by contact — and at this one offering
> the traffic goes the other direction.
