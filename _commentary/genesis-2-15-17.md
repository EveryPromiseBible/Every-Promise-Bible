...
prohibition. Read the sentence and the proportions are the other way round.
...
intensifies: *eating you shall eat*. Every tree. Then one exception.

The Illumination's phrase for it is *a generous word*, and that is a fair reading
of the grammar. The restriction exists inside an abundance, and it is a fraction
of it.
...
Which is why the serpent's pitch in the next chapter is exactly that — *you will
