...
The chapter has been building since Melchizedek arrived. See the note on Hebrews 7:1–2.

## The word for another

The Greek is **heteros** — another of a different kind, not **allos**, another of the same
kind.

Not one more Levite. A different sort of priest.
...
The Levitical priesthood ran on descent. A man was a priest because of who his father was,
and Ezra excluded men who could not produce the paperwork.

It also ran on mortality. Every high priest died and another took over — the chapter says so
a few verses earlier: *there were many priests, because they were prevented by death from
continuing*.
...
**Akatalutos** — that cannot be dissolved or broken up. It occurs once in the New Testament.

The credential is not lineage or appointment. It is that He is not going to die.
...
The whole argument rests on one line of one psalm, written by David, about a figure who
appears in three verses of Genesis.
...
The Greek for *annulling* is **athetesis** — a legal term for setting aside, cancelling.
...
The Greek is **anametaletos** — He will not change His mind.
...
And *always lives* is the same point again: the intercession does not stop because the
intercessor does not die.
...
> **The credential.** Not descent and not appointment. *The power of an indissoluble life* —
> the priesthood holds because the priest does not die.
