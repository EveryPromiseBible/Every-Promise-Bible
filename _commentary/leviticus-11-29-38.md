...
They are the small things that get into a house — under a jar, into a store cupboard, into
the water.
...
The whole system runs on contact and time.
...
Volume and flow beat contamination.
...
A dead unclean animal lands on a sack of grain intended for planting, and the grain is not
affected.
...
Water is what makes it vulnerable, because water is what starts it germinating. The moment
the seed begins to swell and open, it can be reached.

Dry, it is sealed. Nothing gets in.

## Where the seed image is used

*The seed is the word of God.* See the note on Matthew 13:18–23.

*Born again, not of corruptible seed but incorruptible.* See the note on 1 Peter 1:23.

And *each carrying its own seed to make more of its kind* — the clause built in on the third
day. See the note on Genesis 1:9–13.
...
The dietary code is given a reason, and it is a reason about separateness rather than about
hygiene.
...
> **The clause at the end.** Dry seed is untouchable. It is the moment water is put on it —
> the moment it starts to open — that it can be reached at all.
