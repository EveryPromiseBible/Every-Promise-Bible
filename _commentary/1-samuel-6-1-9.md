...
Eli fell backwards off his seat when he heard, and his daughter-in-law named her son Ichabod.

## What the seven months contained

Dagon on his face before the ark, twice — the second time with his head and hands broken off on
the threshold.
...
Pagan diviners using the correct Levitical term.

The offering with a valuation attached, and with restitution built in. See the note on
Leviticus 5:14–19.
...
Models of the affliction, in gold, sent back with what caused it.

## The rats

The Hebrew mentions rats *that are ravaging the land*, which the earlier narrative does not.

Tumours and rats together is a description that has interested epidemiologists for a long
time.
...
Said by Philistine diviners about a God they do not serve.
...
Four hundred years on, in a different country, the exodus is the case law the Philistine
priesthood reasons from.
...
Two variables, both loaded against the result.
...
They state the null hypothesis before running the experiment.

Pagan priests designing a controlled test, naming both outcomes in advance, and agreeing to
accept either.

## What happened

*Then the cows went straight up the road toward Beth-shemesh, keeping to the highway, **lowing
all the way**, not turning to the right or the left.* See the note on
1 Samuel 6:10–12.

## Where the cart comes back

David uses one. New, expensive, and copied from this chapter — and a man dies. See the note on
2 Samuel 6:6–8.
