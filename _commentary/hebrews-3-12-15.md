...
The two nouns are joined. The writer does not treat unbelief as an intellectual position;
he puts it in the same phrase as the badness.
...
The image is of stepping back rather than of falling.
...
**Every single day** — the Greek is *day by day*.

The remedy for a heart hardening is other people, applied daily.

The writer says the same thing in chapter 10: *do not drop out of gathering together, the
way some have gotten into the habit of doing… keep encouraging each other.* See the note on
Hebrews 10:23–25.
...
The hardening is described as the result of being lied to rather than of choosing badly.

Paul says it the same way: *sin found its opening in the commandment, **deceived me**, and
through it killed me.* See the note on Romans 7:9–12.
...
Perfect tense: we have become and remain.
...
Each repetition presses a different word. See the notes on Hebrews 3:7–11 and
Hebrews 3:16–19.

## What the whole chapter is doing

Comparing two houses — Moses' and Christ's — and then warning against repeating what
happened to the generation Moses led.
