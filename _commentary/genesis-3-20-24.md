---
key: Genesis 3:20–24
title: Garments of skin, and the sword at the gate
sources:
...
together: a name, a set of clothes, and an expulsion.
...
death sentence, Adam names his wife **Life**.

The only thing he has to go on is the promise about her seed, three verses
earlier.
...
God's replacement required an animal to die — the first death in Scripture, and
it happens so that two guilty people can be dressed. He does not hand them the
skins. He clothes them.
...
immortality in a fallen condition would have locked the ruin in permanently. The
gate is shut so that the situation stays fixable.

## The guards

Cherubim, with a sword, guarding the way back.

The next time cherubim appear in Scripture they are hammered out of gold at
