...
down, everything is going to be shaken, our God is a fire that burns things up.
Read as the finish of the argument that has been building since the two
mountains, it is doing almost the opposite.

## The purpose clause is the whole thing
...
with an ordinary participle — things being shaken. What remains is *asaleutos*,
a single word meaning unshakable, immovable. It is not that the kingdom survives
the shaking. It is that it is not the kind of thing shaking touches.
...
just spent four verses explaining. Fire is what removes what will not last. Set
next to the sentence before it — a kingdom that cannot be shaken — the fire is
not aimed at the person holding the kingdom. It is aimed at everything that
could not have held them.

## What this is for, practically

Everyone is standing on a mix of things: what God has said, and a quieter set of
supports we would rather not test — how the year went, how disciplined we have
been lately, what other people think. This passage says a day comes when
everything of that second kind goes, and the point of saying so is not to
...
> people the writer has just told they have already arrived at Zion.
