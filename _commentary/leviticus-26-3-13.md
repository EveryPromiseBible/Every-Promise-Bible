...
The whole section is conditional, and the second half of the chapter — thirty verses of it — sets
out what happens otherwise.
...
The promise is that each harvest will be so large it is still being processed when the next
begins. The agricultural year will have no gap in it.
...
The ratio improves as the number grows, which is not how arithmetic works, and the text lets it
stand.
...
Not last year's. Older than that. The problem described is storage.
...
**Mishkan** — the tabernacle. The word for the tent itself.

## What the list has been building to

Rain, harvest, safety, sleep, victory, storage problems — and then the sentence that says
*and best of all*.

The material blessings are real and stated at length. The chapter ranks them anyway.
...
people.* See the note on Revelation 21:3–4.
...
The chapter of conditions ends by naming something already done, unconditionally, before any of
it was asked.

> **The ranking.** Rain, harvests too big to store, sleep without fear — and then *and best of
> all*, which turns out to be a tent pitched in the middle of the camp.
