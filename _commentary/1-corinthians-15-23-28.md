...
Paul is arguing for the resurrection against people who had decided it was
nonsense, and here he sets out the order of events.

## "The last enemy that will be destroyed is death"

Two things in that sentence are easy to miss.

**Enemy.** Death is not described as natural, or as a doorway, or as part of the
design. It is on a list of hostile powers being put down. The Bible's usual
tenderness about death — falling asleep, departing — never softens into calling
it a friend.

**Last.** It goes, but it goes at the end. Everything else is subdued first. That
is a straight answer to the question of why death is still here if it has been
defeated: Paul says the defeat is real and the removal is scheduled.

## The order

*Christ the firstfruits, and afterward those who are Christ's at His coming.*

Firstfruits is a harvest word — the first sheaf brought in, which is not a
sample but a guarantee. The rest of the field is coming, and it will be the same
crop.
...
> in all.* It reads oddly against everything else the New Testament says about
> Christ's glory — and it is Paul's way of saying that the goal of the whole
> operation is not a rearranged universe with a new authority in charge, but God
> filling everything, with nothing left out and nothing left over.
