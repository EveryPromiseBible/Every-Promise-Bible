...
The man is Samuel — prophet, judge, the last of the old order, and the one who will anoint
Israel's first two kings.

Neither of them names him.
...
The whole meeting happens because a servant had loose change.
...
The narrator interrupts his own story to explain a word that had gone out of use by the
time he wrote.

The older title is about the eyes.
...
Twenty-four hours' notice, and a meal already prepared with a portion set aside.
...
> explain that a prophet used to be called somebody who sees.
