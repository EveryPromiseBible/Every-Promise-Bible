...
*"But **justice must still be clear**."*

The cities of refuge are not a loophole. The passage that establishes them is immediately
followed by the test for who does not qualify.
...
made of in that world.

Picking one up is treated as evidence of intent.
...
No weapon is needed. A shove is enough if the hatred was there first.

## What the two lists do together

Between them they cover both ways a death can be deliberate — by what was in the hand,
and by what was in the heart.

Everything else falls into the other category, and the six cities are for that.
...
He is permitted to act on a murderer, and forbidden to touch a man inside a refuge until
the trial.
...
The man who did it by accident, and everyone who ran. See the note on
Numbers 35:9–15.
...
The exact category the cities were built for — the man who caused a death without
knowing. See the note on Luke 23:32–38.

> **Why the second list exists.** So that the refuge means something. A shelter with no
> boundary is not a shelter; the chapter draws the line first and then leaves the door
> open on the other side of it.
